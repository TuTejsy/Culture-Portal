...
const AuthorPreview = ({ lang, author }) => {
  ...
  return (
    <div
      className="author-preview d-flex flex-column flex-md-row w-75 mt-5 rounded"
      style={{
        margin: "0 auto",
    ...
    >
      ...
      <div className="author-preview-body mt-3 mb-3 ml-3">
        ...
        <p className="author-preview-text">
          <em>{author.language[lang].birthPlace}</em>
        </p>
        <p
          className="author-preview-text font-weight-bold"
          style={{ fontSize: "14px" }}
        >
